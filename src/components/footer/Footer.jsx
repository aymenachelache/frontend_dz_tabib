...
export const Footer = ({ t }) => {
    return (
        <footer className="font-sans tracking-wide bg-primary px-8 py-8">
                    ...
                    <ul className="space-y-5 mt-6">
                        <li>
                            <a
                                ...
                                className="hover:text-white text-gray-300 text-sm"
                            >
                                {t("Footer.Doctor.JoinVezeetaDoctors")}
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul className="space-y-5 mt-6">
                        ...
                        <li>
                            <a
                                ...
                                className="hover:text-white text-gray-300 text-sm"
                            >
                                {t("Footer.Help.DoctorsPrivacyPolicy")}
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div className="flex justify-between flex-wrap max-md:flex-col gap-4">
                ...
                <p className="text-gray-300 text-sm">
                    © DZ_TABIB. {t("Footer.AllRightsReserved")}.
                </p>
            </div>
        </footer>
